...
public class Journey implements Cloneable, Serializable, Comparable<Journey> {
    ...
    private static final String REMAININGPLACES = ", remaining places : ";
    /**
     * origin
     */
    String start;
    ...
    public String toString() {
        return new StringBuilder(Journey.TRAJECTFROM).append(start).append(Journey.TO).
                ...
                append(Journey.COST).append(cost).append(Journey.PROPOSEDBY).append(proposedBy).
                append(Journey.REMAININGPLACES).append(places).toString();
    }
